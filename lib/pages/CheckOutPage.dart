              ...
              Expanded(
                child: Container(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(backgroundColor: Colors.pink,textStyle: TextStyle(color: Colors.white)),
                    onPressed: () {
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: Colors.pink,shape:RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(24))), ),
                      child: Text(
                        "Track Order",
