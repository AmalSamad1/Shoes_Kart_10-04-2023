...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void createListItem() {
    ...
    listSection.add(createSection(
        "Payment Method", "images/ic_payment.png", Colors.teal.shade800,InviteFriendsPage()));
    listSection.add(createSection(
        "Settings", "images/ic_settings.png", Colors.red.shade800,AboutPage() ));
    listSection.add(createSection(
        "Invite Friends",
    ...
    listSection.add(createSection(
        "Logout", "images/ic_logout.png", Colors.red.withOpacity(0.7), AboutPage()));
  }
