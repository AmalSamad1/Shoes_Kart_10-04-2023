        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(padding: EdgeInsets.symmetric(vertical: 16),backgroundColor: Colors.blue),
          ...
          Expanded(
            child: Container(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(padding:EdgeInsets.symmetric(vertical: 14), backgroundColor:  Colors.blue,),
